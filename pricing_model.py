...
Original file is located at
    https://colab.research.google.com/drive/1PDF_pWzTrlgl1AwY53vIeBQIHIBEVC39
"""
...
# reading in the data
df = pd.read_csv('/drive/My Drive/Colab Notebooks/sample_pricing.csv', index_col=0)
...
# dropping doors and deleted_at because we will not use them in the model
df1 = df.drop(['doors', 'deleted_at'], axis=1)
...
print(metrics.mean_absolute_error(Y_test, y_pred_dummy_mean))
print(np.sqrt(metrics.mean_squared_error(Y_test, y_pred_dummy_mean)))
print(mean_absolute_percentage_error(Y_test, y_pred_dummy_mean))
